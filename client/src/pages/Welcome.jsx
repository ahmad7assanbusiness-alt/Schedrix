...
const styles = {
  page: {
    ...
    paddingTop: "max(calc(var(--spacing-lg) + var(--spacing-xl)), env(safe-area-inset-top, 0px))",
    paddingBottom: "max(var(--spacing-lg), env(safe-area-inset-bottom, 0px))",
    paddingLeft: "max(var(--spacing-lg), env(safe-area-inset-left, 0px))",
  ...
  themeToggle: {
    position: "absolute",
    top: "max(var(--spacing-lg), calc(env(safe-area-inset-top, 0px) + var(--spacing-sm)))",
    right: "max(var(--spacing-lg), calc(env(safe-area-inset-right, 0px) + var(--spacing-sm)))",
    padding: "var(--spacing-sm) var(--spacing-md)",
